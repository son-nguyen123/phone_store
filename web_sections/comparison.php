...
<section class="page-section bg-light" id="about">
    ...
    <div id="interfaceACustom" style="display: block;">
        ...
        <table class="comparisonTableCustom">
            ...
            <tbody>
                <tr><td>Image</td><td><img id="product1-image" src="default.jpg" /></td><td><img id="product2-image" src="default.jpg" /></td></tr>
                <tr><td>Price</td><td id="product1-price">N/A</td><td id="product2-price">N/A</td></tr>
                <tr><td>Brand</td><td id="product1-brand">N/A</td><td id="product2-brand">N/A</td></tr>
                <tr><td>Storage</td><td id="product1-storage">N/A</td><td id="product2-storage">N/A</td></tr>
                <tr><td>Screen Size</td><td id="product1-screen-size">N/A</td><td id="product2-screen-size">N/A</td></tr>
                <tr><td>Screen Technology</td><td id="product1-screen-technology">N/A</td><td id="product2-screen-technology">N/A</td></tr>
                <tr><td>Rear Camera</td><td id="product1-rear-camera">N/A</td><td id="product2-rear-camera">N/A</td></tr>
                <tr><td>Front Camera</td><td id="product1-front-camera">N/A</td><td id="product2-front-camera">N/A</td></tr>
                <tr><td>Chipset</td><td id="product1-chipset">N/A</td><td id="product2-chipset">N/A</td></tr>
                <tr><td>Internal Memory</td><td id="product1-internal-memory">N/A</td><td id="product2-internal-memory">N/A</td></tr>
                <tr><td>SIM Type</td><td id="product1-sim-type">N/A</td><td id="product2-sim-type">N/A</td></tr>
                <tr><td>Screen Resolution</td><td id="product1-screen-resolution">N/A</td><td id="product2-screen-resolution">N/A</td></tr>
            </tbody>
        </table>
    </div>
</section>
